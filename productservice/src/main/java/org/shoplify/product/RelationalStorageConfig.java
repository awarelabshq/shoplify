...
@Configuration
@EnableJpaRepositories(basePackages = {"org.shoplify.product.repos"}, entityManagerFactoryRef = "h2EntityManagerFactory", transactionManagerRef = "h2TransactionManager")
public class RelationalStorageConfig {
    ...
    public LocalContainerEntityManagerFactoryBean h2EntityManagerFactory(@Autowired DataSource h2DataSource) {
        ...
        em.setPackagesToScan("org.shoplify.product.model");
