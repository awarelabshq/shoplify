...
INSERT INTO products (seller_id, available_quantity, metadata, title, description, image_url) VALUES
  ...
  (2, 80, '{"unitPrice": 1200.0, "availableCountries": ["AU", "CA", "IN"], "categories": ["shoes", "luxury"]}', 'Patent Leather Pumps', 'Step out in style with these patent leather pumps, featuring a sleek silhouette and a comfortable heel.', 'https://storage.googleapis.com/shoplify_tc_assets/cat_bag_icon.png'),
  (2, 120, '{"unitPrice": 300.0, "availableCountries": ["US", "UK", "SG"], "categories": ["slippers", "luxury"]}', 'Silk Embroidered Slippers', 'Indulge your feet in the ultimate luxury with these exquisite silk embroidered slippers, perfect for lounging in style.', 'https://storage.googleapis.com/shoplify_tc_assets/cat_bag_icon.png'),
  ...
  (3, 100, '{"unitPrice": 950.0, "availableCountries": ["SG", "CA", "IN"], "categories": ["shoes", "luxury"]}', 'Velvet Loafers', 'Elevate your style with these luxurious velvet loafers, featuring a sleek design and comfortable fit.', 'https://storage.googleapis.com/shoplify_tc_assets/cat_bag_icon.png'),
  (3, 90, '{"unitPrice": 550.0, "availableCountries": ["US", "UK", "AU"], "categories": ["watches", "luxury"]}', 'Swiss Automatic Watch', 'Precision crafted in Switzerland, this automatic watch is a timeless piece of luxury and elegance.', 'https://storage.googleapis.com/shoplify_tc_assets/cat_bag_icon.png'),
  (3, 70, '{"unitPrice": 1200.0, "availableCountries": ["SG", "CA", "IN"], "categories": ["watches", "luxury"]}', 'Diamond-Encrusted Watch', 'Dazzle with this stunning diamond-encrusted watch, a true symbol of luxury and opulence.', 'https://storage.googleapis.com/shoplify_tc_assets/cat_bag_icon.png');