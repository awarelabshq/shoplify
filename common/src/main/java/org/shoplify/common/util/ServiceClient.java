...
public class ServiceClient {
    ...
    public static final String USERSERVICE_URL = "http://userservice/";
    public static final String PRODUCTSERVICE_URL = "http://productservice/";

    public static <T extends Message> T callService(String url, Object requestBody, Class<T> responseType) throws IOException {
